...
public abstract class ButtonBase : MonoBehaviour
{
    ...
    public static event Action<ButtonBase> onStaticHover;
    public static event Action<ButtonBase> onStaticPress;
    public static event Action<ButtonBase> onStaticDisselect;
    public static event Action<ButtonBase> onStaticClick;

    // Can be externally overriten
    public static Func<bool> useMouse = () => Input.mousePresent;
    public static Func<Canvas> getCanvas = () => FindObjectOfType<Canvas>();
    ...
    {
        bool useMouse = ButtonBase.useMouse();
