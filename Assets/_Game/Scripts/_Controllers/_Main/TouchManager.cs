...
public class GameTouch
{
    ...
    public void UpdateInput(Vector2 position, InputState state, Vector2 deltaPos)
    {
    ...
    public GameTouch(int id, Vector2 position, InputState state, Vector2 velocity)
    {
        this.id = id;
        this.screenPos = position;
        this.state = state;
        this.deltaPos = velocity;
